<div class="space-y-2">
    @php
        ...
        $proofUrl = route('admin.payment-transactions.proof', ['transaction' => $transaction->id]);
    @endphp
    ...
    @if ($isPdf)
        <div class="rounded-lg border border-gray-300 dark:border-gray-600 p-4 bg-gray-50 dark:bg-gray-800">
            ...
            <object data="{{ $proofUrl }}" type="application/pdf" class="w-full" style="height: 600px;">
        ...
        <div class="rounded-lg border border-gray-300 dark:border-gray-600 overflow-hidden">
            <a href="{{ $proofUrl }}" target="_blank">
                <img src="{{ $proofUrl }}" alt="إثبات الدفع"
                    class="w-full h-auto max-h-[600px] object-contain bg-gray-50 dark:bg-gray-800" />
            </a>
        </div>
