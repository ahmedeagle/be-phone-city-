...
class OrderController extends Controller
{
    ...
    public function store(StoreOrderRequest $request)
    {
        ...
        $orderData = [
            ...
            'vip_discount' => $calculations['vip_discount'],
            'vip_tier_at_order' => $calculations['vip_tier'],
            'vip_tier_label' => $calculations['vip_tier'] !== 'regular'
                ? $calculations['vip_tier_label_ar']
                : null,
    ...
    protected function buildPreviewResponse(
        ...
        return [
            ...
            'summary' => [
                ...
                'vip_discount' => number_format($calculations['vip_discount'], 2),
                'vip_tier' => $calculations['vip_tier'],
                'vip_tier_discount_percentage' => $calculations['vip_tier_discount_percentage'],
                'vip_max_discount' => number_format($calculations['vip_max_discount'] ?? 0, 2),
                'vip_tier_label_ar' => $calculations['vip_tier_label_ar'] ?? '',
                'vip_tier_label_en' => $calculations['vip_tier_label_en'] ?? '',
                ...
                'min_items_for_free_shipping' => $minItemsForFreeShipping,
