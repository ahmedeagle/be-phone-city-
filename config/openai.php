...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The OpenAI model to use for the chatbot. Defaults to gpt-3.5-turbo which
    | is widely available. You can use:
    | - gpt-3.5-turbo (recommended, most accessible)
    | - gpt-4o-mini (newer, cheaper alternative)
    | - gpt-4o (if you have access)
    | - gpt-4-turbo (if you have access)
    */

    'chatbot_model' => env('OPENAI_CHATBOT_MODEL', 'gpt-3.5-turbo'),
];
