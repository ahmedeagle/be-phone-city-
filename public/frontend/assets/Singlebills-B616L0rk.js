import{j as e}from"./vendor-mui-2cHuhLvv.js";import{g as A,l as R,r as v}from"./vendor-react-D-Ndkw3L.js";import{u as P,L as j}from"./index-CnSfGh17.js";import{S as I}from"./Sidebar-gINVVrdl.js";import{u as C}from"./vendor-i18n-Dzw_n1Df.js";import"./addressStore-B9JjBlQC.js";import"./profileStore-pwfFoGh9.js";import{a as k}from"./ordersStore-C2dkPKjd.js";import{r as E}from"./vendor-html2pdf-DS46S6o7.js";import"./vendor-zustand-BLdIKjHb.js";import"./vendor-axios-C7aFLusC.js";import"./vendor-swiper-adhIqUnC.js";import"./vendor-toast-CM0JZaQ8.js";function O({title:d,points:o,btn:y,onPrint:p,onShare:c}){const{t:x}=C(),s=()=>{p?p():window.print()};return e.jsx("div",{children:e.jsxs("div",{className:"w-full min-h-[45px] p-4 my-5 bg-[#E5E5E5] flex flex-col sm:flex-row items-center justify-between gap-3 rounded-[8px]",children:[e.jsx("p",{className:"text-[#211C4D] text-[20px] sm:text-[24px] font-[500]",children:d}),e.jsx("p",{className:"text-[#211C4DCC] text-[14px] sm:text-[16px] font-[500]",children:o}),y?e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{className:"w-[129px] h-[35px] bg-[#211C4D] rounded-[8px] text-white text-[14px] sm:text-[16px] whitespace-nowrap",onClick:s,children:x("PrintInvoice",{defaultValue:"طباعه الفاتوره"})}),c&&e.jsxs("button",{className:"h-[35px] px-3 bg-[#211C4D] rounded-[8px] text-white text-[14px] sm:text-[16px] whitespace-nowrap flex items-center gap-1.5",onClick:c,title:x("ShareInvoice",{defaultValue:"مشاركة الفاتورة"}),children:[e.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("circle",{cx:"18",cy:"5",r:"3"}),e.jsx("circle",{cx:"6",cy:"12",r:"3"}),e.jsx("circle",{cx:"18",cy:"19",r:"3"}),e.jsx("line",{x1:"8.59",y1:"13.51",x2:"15.42",y2:"17.49"}),e.jsx("line",{x1:"15.41",y1:"6.51",x2:"8.59",y2:"10.49"})]}),x("Share",{defaultValue:"مشاركة"})]})]}):null]})})}var F=E();const _=A(F);function Z(){const{id:d}=R(),{currentInvoice:o,singleLoading:y,singleError:p,fetchInvoiceById:c}=k(),x=v.useRef(null),{lang:s="ar"}=P();C();const t=s==="ar";v.useEffect(()=>{d&&c(parseInt(d))},[d,c]);const z=()=>{if(!o?.order)return{subtotal:0,tax:0,total:0};const r=o.order.items.reduce((f,h)=>f+h.total,0),i=r*.15,$=r-i,a=o.order.shipping||0,m=r+a;return{subtotal:$,tax:i,total:m}},{subtotal:b,tax:u,total:g}=z(),D=()=>{if(!o)return;const r=window.open("","_blank");if(!r){alert("Please allow popups to print the invoice.");return}const l=`
        <!DOCTYPE html>
    ...
    `;r.document.write(l),r.document.close()},[L,S]=v.useState(!1),T=async()=>{if(!o||L)return;S(!0);let r=null;try{const l=`${t?"فاتورة":"Invoice"} #${o.invoice_number}`,i=t?`فاتورة من City Phones - رقم ${o.invoice_number}`:`Invoice from City Phones - #${o.invoice_number}`,$=`
        <!DOCTYPE html>
        <html lang="${s}" dir="${t?"rtl":"ltr"}">
        <head>
          <meta charset="UTF-8">
      ...
      `;if(typeof _!="function")throw new Error("مكتبة التصدير غير متوفرة");r=document.createElement("iframe"),r.style.position="fixed",r.style.left="-10000px",r.style.top="0",r.style.width="1000px",r.style.height="1000px",document.body.appendChild(r);const a=r.contentDocument||r.contentWindow?.document;if(!a)throw new Error("فشل في إنشاء إطار للطباعة");a.open(),a.write($),a.close(),await new Promise(n=>setTimeout(n,500));const m=`Invoice-${o.invoice_number}.pdf`,f=await Promise.race([_().set({margin:10,filename:m,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:!0,onclone:n=>{n.querySelectorAll('link[rel="stylesheet"], style').forEach(w=>w.remove())}},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"}}).from(a.body).toPdf().output("blob"),new Promise((n,w)=>setTimeout(()=>w(new Error(t?"انتهت مهلة تجهيز ملف المشاركة":"Share file generation timed out")),2e4))]),h=new File([f],m,{type:"application/pdf"});if(typeof navigator.share=="function"&&typeof navigator.canShare=="function")try{if(navigator.canShare({files:[h]})){await navigator.share({title:l,text:i,files:[h]});return}}catch{}const N=URL.createObjectURL(f);try{const n=document.createElement("a");n.href=N,n.download=m,document.body.appendChild(n),n.click(),document.body.removeChild(n)}finally{URL.revokeObjectURL(N)}}catch(l){l?.name!=="AbortError"&&alert(`حدث خطأ أثناء المشاركة: ${l.message||String(l)}`)}finally{r&&r.parentNode&&r.parentNode.removeChild(r),S(!1)}};return y?e.jsx(j,{children:e.jsx("div",{className:"flex justify-center items-center h-64",children:e.jsx("p",{children:t?"جاري تحميل تفاصيل الفاتورة...":"Loading invoice details..."})})}):p||!o?e.jsx(j,{children:e.jsx("div",{className:"flex justify-center items-center h-64",children:e.jsx("p",{className:"text-red-500",children:p||(t?"لم يتم العثور على الفاتورة":"Invoice not found")})})}):e.jsx("div",{children:e.jsx(j,{children:e.jsxs("div",{className:"flex flex-col md:flex-row justify-center gap-[30px] mt-[80px] mb-20",children:[e.jsx(I,{}),e.jsxs("div",{className:"md:w-[883px] w-full",children:[e.jsx(O,{title:`${t?"تفاصيل الفاتورة":"Invoice Details"} #${o.invoice_number}`,btn:!0,onPrint:D,onShare:T}),e.jsxs("div",{ref:x,children:[e.jsx("div",{className:"overflow-x-auto w-[100vw] md:w-[60vw] lg:w-full xl:w-[883px] md:px-0 px-[20px]",children:e.jsxs("table",{dir:t?"rtl":"ltr",className:`w-full border-separate border-spacing-y-3 mt-6 text-center min-w-[883px] ${t?"!rtl":"!ltr"}`,children:[e.jsx("thead",{}),e.jsx("tbody",{className:"bg-white",children:o.order.items.map(r=>e.jsxs("tr",{className:"h-[108px]",children:[e.jsx("td",{className:"text-[#211C4D] w-[32%] border-b font-[500] py-4",children:e.jsxs("div",{className:`flex justify-start w-[243px] h-[76px] p-1 bg-[#cbcbcb2b] border rounded-[8px] items-center gap-3 ${t?"rtl":"ltr"}`,children:[e.jsx("img",{src:r.product.main_image||"https://via.placeholder.com/75",alt:t?r.product.name_ar||r.product.name:r.product.name_en||r.product.name,className:"w-[75px] h-[76px] object-contain rounded-md"}),e.jsxs("div",{className:`w-[140px] ${t?"text-start":"text-left"}`,children:[e.jsx("p",{className:"font-[600] text-[14px] text-[#211C4D] line-clamp-2 leading-tight",title:r.product.name,children:t?r.product.name_ar||r.product.name:r.product.name_en||r.product.name}),e.jsxs("div",{className:`flex flex-col ${t?"items-end":"items-start"}`,children:[e.jsxs("p",{className:"text-[14px] text-[#6c6c80] mt-1",children:["×",r.quantity]}),r.product_option&&e.jsx("p",{className:"text-[14px] text-[#6c6c80]",children:r.product_option.value})]})]})]})}),e.jsx("td",{className:"border-b py-4",children:e.jsx("div",{className:`flex justify-center w-full items-center gap-3 ${t?"rtl":"ltr"}`,children:e.jsxs("p",{children:[r.price.toLocaleString()," ",t?"رس":"SAR"]})})}),e.jsx("td",{className:"text-[#211C4D] border-b text-center font-[500] py-4",children:e.jsx("div",{className:"w-full flex items-center justify-center",children:e.jsx("p",{children:r.quantity})})}),e.jsx("td",{className:"text-[#211C4D] border-b font-[500] py-4",children:e.jsx("div",{className:"w-full flex items-center justify-center",children:e.jsxs("p",{children:[r.total.toLocaleString()," ",t?"رس":"SAR"]})})})]},r.id))})]})}),e.jsxs("div",{className:"md:w-[883px] shadow-[0_4px_8px_rgba(0,0,0,0.2)] rounded-xl bg-white py-4 px-6 mt-4",children:[e.jsx("h2",{className:"text-[24px] font-[500] text-[#211C4D] mb-4",children:t?"تفاصيل الدفع":"Payment Details"}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("p",{className:"text-[16px] font-[500] text-[#211C4D]",children:t?"المجموع الفرعي":"Subtotal"}),e.jsxs("p",{className:"font-[300] text-[16px] text-[#211C4D]",children:[b.toLocaleString()," ",t?"رس":"SAR"]})]}),e.jsxs("div",{className:"flex items-center my-5 justify-between",children:[e.jsx("p",{className:"text-[16px] font-[500] text-[#211C4D]",children:t?"الضريبة المقدرة":"Estimated Tax"}),e.jsxs("p",{className:"font-[300] text-[16px] text-[#211C4D]",children:[u.toLocaleString()," ",t?"رس":"SAR"]})]}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("p",{className:"text-[16px] font-[500] text-[#211C4D]",children:t?"تكلفة الشحن":"Shipping Cost"}),e.jsxs("p",{className:"font-[300] text-[16px] text-[#211C4D]",children:[o.order.shipping?.toLocaleString()||"0"," ",t?"رس":"SAR"]})]}),e.jsxs("div",{className:"flex items-center mt-6 justify-between",children:[e.jsx("p",{className:"text-[24px] font-[500] text-[#211C4D]",children:t?"المجموع الاجمالي":"Total Amount"}),e.jsxs("p",{className:"text-[24px] font-[500] text-[#211C4D]",children:[g.toLocaleString()," ",t?"رس":"SAR"]})]})]}),e.jsxs("div",{className:"md:w-[883px] flex-col md:flex-row flex items-center justify-between shadow-[0_4px_8px_rgba(0,0,0,0.2)] rounded-xl bg-white md:py-4 px-6 py-4 mt-4",children:[e.jsxs("div",{className:`text-center ${t?"md:text-start":"md:text-left"}`,children:[e.jsx("h2",{className:"text-[24px] font-[500] text-[#211C4D] mb-4",children:t?"معلومات الدفع":"Payment Information"}),e.jsx("p",{className:`text-[#211C4D] text-[16px] font-[500] md:mt-2 ${t?"md:mr-2":"md:ml-2"}`,children:t?"طريقه الدفع":"Payment Method"}),e.jsx("p",{className:`text-[24px] text-[#211C4D] font-[500] ${t?"mr-2":"ml-2"}`,children:t?o.order.payment_method?.name_ar||"بطاقة ائتمان":o.order.payment_method?.name_en||o.order.payment_method?.name_ar||"Credit Card"})]}),e.jsxs("div",{className:"mt-4 md:mt-0",children:[e.jsx("p",{className:"text-[16px] font-[500] text-[#211C4D]",children:t?"المبلغ الإجمالي":"Total Amount"}),e.jsx("p",{className:"text-[24px] font-[500] text-[#211C4D]",children:g.toLocaleString()})]}),e.jsx("div",{children:e.jsx("img",{src:"/src/assets/images/sucsespayment.png",className:"w-[100px] h-[122px] object-contain",alt:""})})]})]})]})]})})})}export{Z as default};
